...
exports.COUNTRY_CATALOG = exports.SUPPORTED_LOCALES = void 0;
...
exports.nationalPart = nationalPart;
exports.isValidNationalPhone = isValidNationalPhone;
...
function getCatalogEntry(code) {
    return exports.COUNTRY_CATALOG.find((c) => c.code === code.toUpperCase());
}
// ── Phone helpers ────────────────────────────────────────────────────────────
 ...
 */
function toE164(dialCode, national) {
...
function nationalPart(dialCode, value) {
    const cc = phoneDigits(dialCode);
 ...
 */
function isValidNationalPhone(country, national) {
    const n = phoneDigits(national);
    if (n.length === 0)
        return true;
    if (country.phoneNationalDigits == null)
 ...
 */
function isValidTaxId(country, value) {
    const v = value.trim();
    if (v.length === 0)
        return true;
    if (!country.taxIdPattern)
        return true;
    try {
