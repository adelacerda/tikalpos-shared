...
export type SyncStatus = 'ONLINE' | 'DRAINING' | 'OFFLINE' | 'DEGRADED' | 'RECONCILING' | 'ERROR_BLOCKED';
...
export type OfflineEventType = 'ORDER_OPENED' | 'ORDER_LINE_ADDED' | 'ORDER_LINE_VOIDED' | 'ORDER_FINALIZED' | 'PAYMENT_CAPTURED' | 'PAYMENT_REFUNDED' | 'LOYALTY_EARN' | 'LOYALTY_REDEEM' | 'KDS_TICKET_SENT';
...
export type ReconciliationOutcome = 'APPLIED' | 'DUPLICATE_IGNORED' | 'CAUSAL_GAP_DEFERRED' | 'BUSINESS_REJECTED' | 'SIGNATURE_INVALID';
